module m_read_ESACCI_grid
  ! Reads ESACCI NetCDF dimensions
contains
  subroutine read_ESACCI_grid(filename,gr)
    !use mod_dimensions
    use mod_grid
    use nfw_mod
    implicit none
  ...
  end subroutine read_ESACCI_grid
  
end module m_read_ESACCI_grid
