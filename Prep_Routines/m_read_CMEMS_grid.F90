module m_read_CMEMS_grid
  ! Reads CMEMS NetCDF dimensions
contains
  subroutine read_CMEMS_grid(filename,gr)
    !use mod_dimensions
    use mod_grid
    use nfw_mod
    implicit none
  ...
  end subroutine read_CMEMS_grid
  
end module m_read_CMEMS_grid
