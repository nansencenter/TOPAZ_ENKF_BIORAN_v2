module m_read_ESACCI_SST
  ! Reads ESACCI SST data after having read the grid in read_ESACCI_grid

  integer, parameter, private :: STRLEN = 512

contains

  subroutine read_ESACCI_SST(filename,gr,data)
    use mod_measurement
    use mod_grid
    use m_spherdist
    use netcdf
  ...
  end subroutine read_ESACCI_SST
end module m_read_ESACCI_SST
